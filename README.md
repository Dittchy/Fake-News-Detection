...
9.  **Run Streamlit App**:
    ...
    **Features Included**:
    *   **Detective Theme UI**: Custom "Batman/Spy" styled interface.
    *   **Live Inference**: Real-time checking using the Ensemble model.
    *   **Visual Evidence Board**: SHAP explanation for word-by-word analysis.
